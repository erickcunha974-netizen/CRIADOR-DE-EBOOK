...
import { BookOpen, Image as ImageIcon, Download, Settings, Languages, PlusCircle, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="w-72 bg-slate-900 border-r border-slate-800 h-screen flex flex-col shrink-0">
      ...
      <div className="p-4 border-t border-slate-800 space-y-2">
         <button 
            onClick={handleReset}
            className="w-full flex items-center justify-center gap-2 text-xs font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 py-2 rounded-lg transition-colors"
         >
            <Trash2 size={14} />
            {t.newProject}
         </button>
